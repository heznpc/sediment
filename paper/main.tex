...
% copy-pasting 37 entries each time. Run the build from the paper/
% directory so BibTeX finds refs.bib without BIBINPUTS:
%   (cd paper && latexmk -pdf main.tex)
% or from the repo root:
%   make pdf
% CI sets working_directory: paper to match this contract.
